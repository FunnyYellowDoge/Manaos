/datum/map/nano/setup_map()
	..()
	system_name = generate_system_name()
	minor_announcement = new(new_sound = sound('sound/AI/torch/commandreport.ogg', volume = 45))

/datum/map/nano/get_map_info()
	. = list()
...
/datum/map/nano/send_welcome()
	...
	var/obj/effect/overmap/visitable/nano = map_sectors["1"]

	welcome_text += "Coordenadas actuales:<br /><b>[nano.x]:[nano.y]</b><br /><br>"
	...
	for(var/obj/effect/overmap/visitable/O in space_things)
		...
		if(O.loc != nano.loc)
			var/bearing = round(90 - Atan2(O.x - nano.x, O.y - nano.y),5) //fucking triangles how do they work
			if(bearing < 0)
				bearing += 360
