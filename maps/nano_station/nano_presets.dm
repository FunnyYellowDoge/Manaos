...
/datum/map/nano/get_network_access(var/network)
	switch(network)
		if(NETWORK_AQUILA)
...
// Substation SMES
/obj/machinery/power/smes/buildable/preset/nano/substation
...
/obj/machinery/power/smes/buildable/preset/nano/substation_full
...
/obj/machinery/power/smes/buildable/preset/nano/engine_main
...
// Shuttle SMES
/obj/machinery/power/smes/buildable/preset/nano/shuttle
	uncreated_component_parts = list(
...
/obj/machinery/power/smes/buildable/preset/nano/hangar
	uncreated_component_parts = list(
		/obj/item/weapon/stock_parts/smes_coil/super_io = 2)
	_input_maxed = TRUE
	_output_maxed = TRUE
...
/datum/map/nano/default_internal_channels()
	return list(
